...
//    WriteOneByteToMainAndSubB0EEPROM(0x85,0x00,0x10);
...
//            command[6] = 0x80;
//            command[7] = 0x01;
//            WriteToEEPROMWithDataSize(command[1], command[2], command[3], &command[5], command[4]);
//            __delay_ms(500);
//        }
...
//        putChar(0xFF);
        ...
        if(RXDATA[0] == 0) continue;      //not receive command-->continue
